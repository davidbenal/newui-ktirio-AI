...
exports.createCustomerPortalSessionExport = exports.createGenerationExport = exports.consumeCreditsExport = exports.getUserCreditsExport = exports.createCustomerPortalSession = exports.createGeneration = exports.consumeCredits = exports.getUserCredits = void 0;
...
exports.getUserCredits = functions.https.onCall(async (data, context) => {
    var _a, _b;
    console.log('💰 getUserCredits called', { userId: (_a = context.auth) === null || _a === void 0 ? void 0 : _a.uid });
    if (!context.auth) {
    ...
    try {
        ...
        if (!subSnapshot.empty) {
            ...
            const plan = plans_1.PLANS[subDoc.planType];
        ...
        for (const doc of packsSnapshot.docs) {
            ...
            const expiresAt = (_b = packData.expiresAt) === null || _b === void 0 ? void 0 : _b.toDate();
        ...
        const usedCredits = ((subscriptionData === null || subscriptionData === void 0 ? void 0 : subscriptionData.used) || 0) + packItems.reduce((sum, p) => sum + p.used, 0);
        const purchasedTotal = ((subscriptionData === null || subscriptionData === void 0 ? void 0 : subscriptionData.monthlyCredits) || 0) + packItems.reduce((sum, p) => sum + p.purchased, 0);
...
exports.getUserCreditsExport = exports.getUserCredits;
// ====================================
// 3.6: CONSUME CREDITS
// ====================================
/**
...
exports.consumeCredits = functions.https.onCall(async (data, context) => {
    var _a;
    console.log('🔥 consumeCredits called', { userId: (_a = context.auth) === null || _a === void 0 ? void 0 : _a.uid, data });
    if (!context.auth) {
        throw new functions.https.HttpsError('unauthenticated', 'User must be authenticated');
    }
    const userId = context.auth.uid;
    const { creditsNeeded = 1 } = data;
    if (creditsNeeded < 1) {
    ...
    try {
        ...
        const result = await db.runTransaction(async (transaction) => {
            ...
            const subSnapshot = await transaction.get(db
                .collection('subscriptions')
                .where('userId', '==', userId)
                .where('status', '==', 'active')
                .where('nextResetDate', '>', now)
            ...
            if (creditsToConsume > 0) {
                const packsSnapshot = await transaction.get(db
                    .collection('creditPacks')
                    .where('userId', '==', userId)
                    .where('isActive', '==', true)
...
exports.consumeCreditsExport = exports.consumeCredits;
// ====================================
 ...
 */
exports.createGeneration = functions.https.onCall(async (data, context) => {
    var _a;
    console.log('🎨 createGeneration called', { userId: (_a = context.auth) === null || _a === void 0 ? void 0 : _a.uid, data });
    if (!context.auth) {
        throw new functions.https.HttpsError('unauthenticated', 'User must be authenticated');
    }
    const userId = context.auth.uid;
    ...
    try {
        ...
        const creditsInfo = await exports.getUserCredits.run(data, context);
        if (creditsInfo.totalCredits < 1) {
            throw new functions.https.HttpsError('resource-exhausted', 'Insufficient credits. Please upgrade your plan or buy a credit pack.', {
        ...
        try {
            // 3. Consumir créditos
            consumeResult = await exports.consumeCredits.run({ creditsNeeded: 1 }, context);
...
exports.createGenerationExport = exports.createGeneration;
/**
 * Processar geração de imagem (async)
 * Em produção, integrar com Google Vision API ou outro serviço
 */
async function processGeneration(generationId, prompt, style) {
    try {
...
exports.createCustomerPortalSession = functions.https.onCall(async (data, context) => {
    var _a, _b;
    console.log('🏛️ createCustomerPortalSession called', { userId: (_a = context.auth) === null || _a === void 0 ? void 0 : _a.uid });
    if (!context.auth) {
        throw new functions.https.HttpsError('unauthenticated', 'User must be authenticated');
    }
    const userId = context.auth.uid;
    try {
        ...
        const session = await stripe.billingPortal.sessions.create({
            ...
            return_url: `${appUrl}${plans_1.CHECKOUT_URLS.portalReturnUrl}`,
        });
...
exports.createCustomerPortalSessionExport = exports.createCustomerPortalSession;
