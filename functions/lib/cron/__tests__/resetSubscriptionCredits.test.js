...
describe('resetSubscriptionCredits', () => {
    ...
    const mockSubscription = {
        ...
        billingCycleStart: firestore_1.Timestamp.now(),
        billingCycleEnd: firestore_1.Timestamp.fromDate(new Date(Date.now() + 30 * 24 * 60 * 60 * 1000)),
        nextResetDate: firestore_1.Timestamp.now()
    };
    describe('Validações', () => {
...
//# sourceMappingURL=resetSubscriptionCredits.test.js.map