...
describe('expireCreditPacks', () => {
    ...
    const mockCreditPack = {
        ...
        isActive: true,
        expiresAt: firestore_1.Timestamp.now(),
        createdAt: firestore_1.Timestamp.fromDate(new Date(Date.now() - 90 * 24 * 60 * 60 * 1000)) // 90 dias atrás
    };
    describe('Validações', () => {
    ...
    describe('Expiration Logic', () => {
        it('deve marcar isActive como false', () => {
            const updatedPack = Object.assign(Object.assign({}, mockCreditPack), { isActive: false });
            expect(updatedPack.isActive).toBe(false);
        });
        it('deve adicionar campo expiredAt', () => {
            const expiredAt = firestore_1.Timestamp.now();
    ...
    describe('Edge Cases', () => {
        it('deve lidar com packs sem expiresAt (não processar)', () => {
            const packWithoutExpiry = Object.assign(Object.assign({}, mockCreditPack), { expiresAt: null });
        ...
        it('deve lidar com creditsRemaining = 0', () => {
            const emptyPack = Object.assign(Object.assign({}, mockCreditPack), { creditsRemaining: 0 });
...
//# sourceMappingURL=expireCreditPacks.test.js.map